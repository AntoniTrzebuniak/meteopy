...
class IMGWSimpleForecaster:
    ...
    def linear_regression_forecast(self, data_type: str, start_date: str, end_date: str, till_predict_date: str, stations: list[str], parametr: str):
        ...
        :param parametr: Parametr do przewidywania
        ...
        for station in stations:
            ...
            if parametr not in parameter_list:
                raise ValueError(f"Parametr {parametr} nie jest obsługiwany.")
            ...
            filtered_data = df[["Data", parametr]].dropna()
            ...
            y_train = filtered_data[parametr].values
    ...
    def plot_forecast(self, data_type: str, start_date: str, end_date: str, till_predict_date: str, stations: list[str], parametr: str):
        ...
        for station in stations:
            X_train, y_train, X_predict_dates, predictions, filtered_data = self.linear_regression_forecast(
                data_type, start_date, end_date, till_predict_date, [station], parametr
            )
            ...
            output_file = os.path.join(output_dir, f"{station}_{parametr}_forecast.png")
